...
Signed Release archive built successfully: version **1.0.26**, build **20260919210242**. Export is waiting for macOS Keychain authorization for the existing iPhone Distribution key. No TestFlight upload or physical APNs delivery is claimed at this stage. Final Apple validation, production entitlements, and distribution receipts will be added after export and upload.
